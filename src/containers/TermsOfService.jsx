        ...
        <div className="flex-1">
          <section className="mt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center gap-12 md:px-8 flex-1">
            ...
            <div className="w-full flex justify-center mb-14">
              <div className="w-4/5 md:w-2/3 font-game flex flex-col gap-5">
                <p className="text-right">Last updated: December 15, 2023</p>

                <p>Welcome to Stat Pick AI!</p>

                <p>
                  These terms of service outline the rules and regulations for
                  the use of Stat Pick AI&apos;s Website, located at
                  https://www.statpickai.com.
                </p>

                <p>
                  By accessing this website we assume you accept these terms and
                  conditions. Do not continue to use Stat Pick AI if you do not
                  agree to take all of the terms of service stated on this page.
                </p>
                ...
                <p>
                  ...
                  the Company&apos;s terms of service. &quot;The Company&quot;,
                  &quot;Ourselves&quot;, &quot;We&quot;, &quot;Our&quot; and
                  &quot;Us&quot;, refers to our Company. &quot;Party&quot;,
                  &quot;Parties&quot;, or &quot;Us&quot;, refers to ourselves.
                ...
                <p>
                  Stat Pick AI operates as a software business focused on
                  artificial intelligence and statistics. Stat Pick AI is not a
                  gambling operator or sports betting operator or a gambling
                  site of any kind, and none of its affiliates or subsidiaries
                  constitute gambling operators or sports betting operators. The
                  material contained on this site is intended to inform and
                  educate the reader and in no way represents an inducement to
                  gamble legally or illegally. Betting is illegal in some
                  countries, or areas of countries. It is the sole
                  responsibility of the user to act in accordance with their
                  local laws.
                </p>
                <h3>
                  <strong>Regarding Artificial Intelligence Analysis</strong>
                </h3>
                <p>
                  <ol>
                    <li></li>
                  ...
                  <li>
                    This content has been created by an AI language model and is
                    intended to provide general information. While we strive to
                    deliver accurate and reliable content, it may not always
                    reflect the latest developments or expert opinions. The
                    content should not be considered as professional or
                    personalized advice. Information used as a result of or as a
                    basis for the AI decisions may be outdated or incorrect. We
                    encourage you to seek professional guidance and verify the
                    information independently before making decisions based on
                    this content. We do our best to make sure all the
                    information that we provide on this site is correct. However
                    from time to time mistakes will be made and we will not be
                    held liable. Please check any stats or information if you
                    are unsure how accurate they are.
                  </li>
                  <li>
                    Whilst we do our upmost to offer good advice and information
                    we cannot be held responsible for any loss that may be
                    incurred as a result of acting on the advice.
                  </li>
                  <li>
                    Whilst we do our upmost to offer good advice and information
                    we cannot be held responsible for any loss that may be
                    incurred as a result of acting on the advice. 3. No
                    guarantees are made with regards to results or financial
                    gain. All forms of betting carry financial risk and it is
                    down to the individual to make bets with or without the
                    assistance of information provided on this site.
                  </li>
                </p>
                <h3>
                  <strong>Paid Accounts</strong>
                </h3>
                <p>
                  Stat Pick AI does not handle any payment information or
                  payment processing. All payment processing is handled by
                  Stripe, a third-party service. Any actions related to payment
                  processing are subject to that third-party&apos;s terms and
                  policies and any issues that arise should be directed to them.
                  If you purchase any service or monthly subscription, you will
                  provide complete and accurate billing information, including a
                  valid payment method. You&apos;re responsible for all
                  applicable taxes, and we&apos;ll charge tax when required. If
                  your payment cannot be completed, we may downgrade your
                  account or suspend your access to our Services until payment
                  is received. You can cancel your paid subscription at any time
                ...
                <p>
                  We strive to ensure complete satisfaction with our services.
                  ...
                  right to determine the eligibility for refunds, and this
                  policy does not entitle a refund in every situation.
                </p>
                <h3>
                ...
                <p>
                  We employ the use of cookies. By accessing Stat Pick AI, you
                  agreed to use cookies in agreement with the Is My Streamer
                ...
                <p>
                  Unless otherwise stated, Stat Pick AI and/or its licensors own
                  the intellectual property rights for all material on Is My
                  Streamer Online. All intellectual property rights are
                  reserved. You may access this from Stat Pick AI for your own
                  personal use subjected to restrictions set in these terms of
                  service.
                </p>

                <p>You must not:</p>
                <ul className="list-disc pl-3">
                  <li>Republish material from Stat Pick AI</li>
                  <li>Sell, rent or sub-license material from Stat Pick AI</li>
                  <li>
                    Reproduce, duplicate or copy material from Stat Pick AI
                  </li>
                  <li>Redistribute content from Stat Pick AI</li>
                </ul>
                ...
                <p>
                  ...
                  website. Stat Pick AI does not filter, edit, publish or review
                  Comments prior to their presence on the website. Comments do
                  not reflect the views and opinions of Stat Pick AI,its agents
                  and/or affiliates. Comments reflect the views and opinions of
                  the person who post their views and opinions. To the extent
                  permitted by applicable laws, Stat Pick AI shall not be liable
                ...
                <p>
                  Stat Pick AI reserves the right to monitor all Comments and to
                ...
                <p>
                  You hereby grant Stat Pick AI a non-exclusive license to use,
                ...
                <p>
                  ...
                  compensates the absence of Is My Streamer Online; and (d) the
                ...
                <p>
                  ...
                  inform us by sending an e-mail to Stat Pick AI. Please include
                ...
                <p>
                  No use of Stat Pick AI&apos;s logo or other artwork will be
                ...
                <p>
                  ...
                  the right to amen these terms of service and it&apos;s linking
                  policy at any time. By continuously linking to our Website,
                  you agree to be bound to and follow these linking terms of
                  service.
                </p>
