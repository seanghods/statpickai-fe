        ...
        <div className="flex-1">
          <section className="mt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center gap-12 md:px-8 flex-1">
            ...
            <div className="w-full flex justify-center mb-14">
              <div className="w-4/5 md:w-2/3 flex flex-col gap-5">
                ...
                <ul className="list-disc pl-3">
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Stat Pick AI.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Stat Pick AI,
                      accessible from{' '}
                      <a
                        ...
                        target="_blank"
                      >
                        https://www.ismystreameronline.com
                      </a>
                    </p>
                  </li>
                  <li>
                ...
                <p>
                  The Company allows You to create an account and may allow you
                  to log in to use the Service through the following Third-party
