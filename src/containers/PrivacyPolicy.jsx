    ...
    <>
      ...
      <div className="w-full flex justify-center mb-14">
        <div className="w-4/5 md:w-2/3 flex flex-col gap-5">
          <h1 className="text-center text-2xl font-saira_bold">
            Privacy Policy
          </h1>
          ...
          <ul className="list-disc pl-3">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Stat Pick AI.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Stat Pick AI, accessible from{' '}
                <a
          ...
          <p>
            ...
            that arise should be directed to them.
          </p>
          <h4>Usage Data</h4>
          ...
          <p>
            The Company allows You to create an account and may allow you to log
