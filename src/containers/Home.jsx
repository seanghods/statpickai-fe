    ...
    <div className="bg-gray-900 relative z-0">
      ...
      <div>
        <section className="mt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center lg:flex flex-col gap-12 md:px-8">
          ...
          <div className="w-full text-left p-7 mt-7 lg:mt-0 lg:ml-3 text-white shadow-gray-300 shadow-lg h-[450px]">
            <Typewriter
          ...
          <div className="max-w-screen-xl mx-auto md:px-8">
            <div className="items-center gap-x-12 sm:px-4 md:px-0 lg:flex">
              <div className="flex-1 sm:hidden lg:block">
                <img
                  src={aiPic}
                  className="md:max-w-lg sm:rounded-lg h-[600px]"
                  alt="Pic of AI Chips"
                />
              </div>
        ...
        <section className="py-28">
          <div className="max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
            <div className="max-w-xl space-y-3 md:mx-auto">
              <h3 className="text-indigo-600 font-semibold">Start now</h3>
