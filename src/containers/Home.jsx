        ...
        <section className="mt-8 md:mt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center lg:flex flex-col gap-12 md:px-8">
          <div className="space-y-4 flex-1 sm:text-center lg:text-left flex flex-col items-center">
            ...
            <div>
              ...
              <p className="text-gray-300 text-center max-w-xl leading-relaxed sm:mx-auto lg:ml-0 text-[17px] mt-8">
                Follow our{' '}
                <a
              ...
              <p className="text-gray-300 text-center max-w-xl leading-relaxed sm:mx-auto lg:ml-0 text-[17px] mt-4">
                Join our{' '}
                <a
