...
import { xSvg } from '../components/sub-components/Icons.jsx';
        ...
        <section className="mt-8 md:mt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center lg:flex flex-col gap-12 md:px-8">
          <div className="space-y-4 flex-1 sm:text-center lg:text-left flex flex-col items-center">
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <p className="pt-8 justify-center items-center gap-2 text-gray-300 text-center leading-relaxed md:w-3/5 text-sm md:text-[18px] mt-4">
                <a
                  href="https://twitter.com/statpickai"
                  target="_blank"
                  rel="noreferrer"
                  className="font-bold text-[#b7bded] hover:brightness-125 whitespace-nowrap gap-2"
                >
                  Follow us on {xSvg(5, 5)}
                </a>{' '}
                for a curated pick of the day generated by AI.
              </p>
              <p className="text-gray-300 text-center leading-relaxed md:w-3/5 text-sm md:text-[18px] mt-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-[#b7bded] font-bold hover:brightness-125"
                >
