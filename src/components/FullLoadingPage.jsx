...
export default function FullLoadingPage() {
  return (
    <>
      <div className="bg-gray-900 relative z-50 min-h-screen min-w-screen flex flex-col">
        <div
        ...
        ></div>
        <div className="w-screen h-screen fixed top-0 left-0 z-50 flex flex-col justify-center items-center">
